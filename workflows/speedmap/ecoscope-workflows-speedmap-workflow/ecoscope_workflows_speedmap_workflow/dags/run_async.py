...
def main(params: Params):
    ...
    dependencies = {
        ...
        "groupers": [],
        "tracks_file": [],
        "load_subject_tracks": ["tracks_file"],
        "rename_traj_columns": ["load_subject_tracks"],
        "traj_add_temporal_index": ["rename_traj_columns", "groupers"],
        "classify_traj_speed": ["traj_add_temporal_index"],
        ...
        "speed_trend_chart": ["trend_predictions"],
    ...
    nodes = {
        ...
        "tracks_file": Node(
            ...
            .set_task_instance_id("tracks_file")
            .handle_errors()
            .with_tracing()
            .skipif(
                conditions=[
            ...
            .set_executor("lithops"),
            partial=(params_dict.get("tracks_file") or {}),
            method="call",
        ),
        "load_subject_tracks": Node(
            async_task=load_df.validate()
            .set_task_instance_id("load_subject_tracks")
            .handle_errors()
            .with_tracing()
            .skipif(
                conditions=[
            ...
            .set_executor("lithops"),
            partial={
                "file_path": DependsOn("tracks_file"),
                "deserialize_json": False,
            }
            | (params_dict.get("load_subject_tracks") or {}),
            method="call",
        ),
        "rename_traj_columns": Node(
            ...
            .set_executor("lithops"),
            partial={
                "df": DependsOn("load_subject_tracks"),
                "rename_columns": {
